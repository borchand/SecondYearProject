...
# and: https://github.itu.dk/robv/intro-nlp2023/blob/main/assignments/week5/rnn.py
## Need the nested-ner-master folder to run as is
import random
import codecs
...
print(train_data[5])
## print out all the unique tags
print(set([tag for sent in train_data for tag in sent[1]]))
...
print(train_feats[5],train_labels[5])
# convert to batches
...
class TaggerModel(torch.nn.Module):
    def __init__(self, nwords, ntags):
        ...
        self.lstm = nn.LSTM(DIM_EMBEDDING, LSTM_HIDDEN, batch_first=True)
    ...
    def forward(self, sentences):
        ...
        rnn_out, _ = self.lstm(dropped_word_vectors, None)
        # Apply dropout
